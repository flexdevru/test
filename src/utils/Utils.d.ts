...
export declare class TextureHelper {
    ...
    static createRoundedTexture: (width: number, height: number, fill: string, strokeColor: string, strokeWidth: number, radius: number, offset?: number) => Promise<PIXI.Texture>;
    static createRoundedTexture2: (width: number, height: number, fill: string, strokeColor: string, strokeWidth: number, radius: number, offset?: number) => PIXI.Texture;
